...
public class UserController {
    ...
    public ResponseEntity<Page<SearchUserResponseDto>> getUsers(
        ...
        Page<SearchUserResponseDto> searchUserResponseDtoPage = userService.findUsers(currentUser,username, email, role, startDate, endDate, pageable);
        return ResponseEntity.ok().body(searchUserResponseDtoPage);
    }
