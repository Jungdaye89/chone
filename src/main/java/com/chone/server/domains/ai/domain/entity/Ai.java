...
import com.chone.server.domains.product.domain.entity.Product;
...
public class Ai extends BaseEntity {
    ...
    public static AiBuilder builder(Store store, Product product, String requestText, String responseText) {
